    ...
    def write_energy(self):
            ...
            for e0 in e0_array:
                for k in k_array:
                    for l in l_array:
                        ...
                        v_Elec_logistic_headers += "v_Elec_"+str(a)+"_"+str(e0)+"_"+str(k)+"_"+str(l)+","
                                
        # Write headers WFA 2020_02_10
        # Write first line (headers)
        self.fo2.write("PDB,Lig,Chain,Number,"+headers_out+v_Elec_logistic_headers+"v_Sol,Torsions,Experimental\n")

        # Write first line (headers)
        self.fo3.write("Name,"+headers_out+v_Elec_logistic_headers+"v_Sol,Torsions,Experimental\n")
        
        # Write first line (headers) for Lennard-Jones potentials
        self.fo4.write("PDB,Lig,Chain,Number,"+headers_LJ+v_Elec_logistic_headers+"v_Sol,Torsions,Experimental\n")
        
        # Write first line (headers) for hydrogen-bond potentials
        self.fo5.write("PDB,Lig,Chain,Number,"+headers_HB+v_Elec_logistic_headers+"v_Sol,Torsions,Experimental\n")
        
        # Write first line (headers) for Lennard-Jones potentials
        self.fo6.write("Name,"+headers_LJ+v_Elec_logistic_headers+"v_Sol,Torsions,Experimental\n")
        
        # Write first line (headers) for hydrogen-bond potentials
        self.fo7.write("Name,"+headers_HB+v_Elec_logistic_headers+"v_Sol,Torsions,Experimental\n")
        ...
        for line in self.csv0:
            ...
            if line[0] == "CHKLIG":
                ...
                aux_line_LJ_HB+\
                ","+v_Elec_logistic+str(v_Sol)+","+str(number_torsions)+","+str(exp_aff)+"\n")
