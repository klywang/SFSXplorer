...
#
# Define class to read a CSV file and process the data
#
class ReadCSV(object):
    """Class to read a CSV file"""

    # Define constructor method
    def __init__(self,file_in,file_out,n_vars):
        """Constructor method"""
    ...
    def read_it(self):
        ...
        # Open CSV file
        pie_in = np.genfromtxt(self.file_in, skip_header = 1, delimiter=",")
...
def main():
    ...
    data_in, data_out = "dataset1.csv", "stats.csv"

    # Instantiate an object of ReadCSV class
    data1 = ReadCSV(data_in,data_out,n_vars=5)
