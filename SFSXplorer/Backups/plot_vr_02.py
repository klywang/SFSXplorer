...
def main():
    ...
    # Import package
    from SFSXplorer import FF_AD4_8 as ff

    # Instantiate an object of the InterMol class
    potentials = ff.InterMol("Inputs/AD4.1_bound.dat")

    # Call plot_plot()
    potentials.plot_pot(type_pot,x_label,y_label,r_min,r_max,reqm_i,epsilon_i,reqm_j,epsilon_j,m,n)
main()